...
window.addEventListener('scroll',updatePositions);document.addEventListener('DOMContentLoaded',makeBackgroundPizzas);var cols=8;var s=256;var movPizzas=document.getElementById("movingPizzas1");function makeBackgroundPizzas(){var elem;var numberOfPizzas=maxPizzasToGenerate();for(var i=0;i<numberOfPizzas;i++){elem=document.createElement('img');elem.className='mover';elem.src="images/pizza.png";elem.style.height="100px";elem.style.width="73.333px";elem.basicLeft=(i%cols)*s;elem.style.top=(Math.floor(i / cols)*s)+'px';movPizzas.appendChild(elem);}
updatePositions();}
