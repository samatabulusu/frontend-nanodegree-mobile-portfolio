...
updatePositions();}
function reMakeBackgroundPizzas(){var children=movPizzas.getElementsByClassName('mover');var numChildren=m.length;for(var i=0;i<numChildren;i++){movPizzas.removeChild(children[i]);}
